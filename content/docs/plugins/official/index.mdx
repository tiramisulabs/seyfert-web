...
| --- | --- | --- |
| [`@slipher/redis-adapter`](/docs/recipes/cache#redis-adapter) | Cache (distributed, Redis-backed) | `pnpm add @slipher/redis-adapter` |
...
| [`@slipher/testing`](/docs/testing) | Test fixtures and helpers for Seyfert apps | `pnpm add -D @slipher/testing` |
| [`@slipher/scaler`](/docs/plugins/official/scaler) | Discover hosts, place gateway workers, and redistribute them live. | `pnpm add @slipher/scaler` |
