...
| [`@slipher/cache-integrity`](/docs/plugins/official/cache-integrity) | Reuse recently written values while isolating stale persistent relationships. |
...
Distributed gateway workers are documented separately in the [Scaling](/docs/learn/scaling) guide. `@slipher/scaler` is infrastructure, not a Seyfert plugin.
