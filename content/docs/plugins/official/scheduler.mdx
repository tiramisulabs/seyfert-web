...
<Callout type="info" title="Release status">
The current npm release is `@slipher/scheduler@1.0.0`. The timezone and overlap policies documented below have landed in `extra` through [pull request #30](https://github.com/tiramisulabs/extra/pull/30) and will be available after the next package release.
</Callout>
