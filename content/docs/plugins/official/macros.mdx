---
title: Macros
description: Automatic context types and application macros for Seyfert.
---
...
This v1 is not published yet. From the Slipher checkout containing `packages/macros`, build a local tarball:
...
In the bot project, install that tarball as a development dependency alongside TypeScript 6.0.x and Seyfert 5.1 or later:
