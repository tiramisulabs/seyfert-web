...
type ClientWithDB = Client & { db: DatabaseClient };

const client = new Client() as ClientWithDB;
...
declare module 'seyfert' {
    interface SeyfertRegistry { client: ClientWithDB }
}
```
...
declare module 'seyfert' {
    interface SeyfertRegistry { client: ParseClient<MyBot> }
}
```
