...
[Yuna](https://www.npmx.dev/package/yunaforseyfert) is an advanced parser for prefix/text commands in Seyfert. It provides custom syntax for named options, dynamic prefixes, and watchers.
