...
[`@slipher/watcher`](https://www.npmjs.com/package/@slipher/watcher) keeps the gateway alive while it watches your source files, rebuilds on change, and restarts the worker.
