...
import { Formatter } from 'seyfert';
// ---cut---
Formatter.userMention('366779196975874049');            // <@366779196975874049>
Formatter.channelMention('1003825079328702529');        // <#1003825079328702529>
Formatter.roleMention('1115437277846458388');           // <@&1115437277846458388>
```
...
For a complete guide on building and handling interactive components (buttons, select menus, modals), see the [Components guide](/docs/learn/components/building-components).

### Quick Reference

```ts twoslash
import { ActionRow, Button } from 'seyfert';
import { ButtonStyle, MessageFlags } from 'seyfert';
