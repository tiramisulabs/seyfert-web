...
<Callout>
This section will assume that you read and understood [how to set up languages](/docs/learn/i18n/languages).
</Callout>
...
declare module 'seyfert' {
    interface SeyfertRegistry { langs: ParseLocales<typeof lang> }
}
// ---cut---
