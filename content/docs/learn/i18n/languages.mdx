...
declare module 'seyfert' {
  ...
  // interface SeyfertRegistry { client: ParseClient<HttpClient> } // If you are using the rest api

  interface SeyfertRegistry { langs: ParseLocales<typeof English> }
}
```
...
<Callout>
You can use any of the language files for the `langs` entry in `SeyfertRegistry` since they should be the same object structure.
</Callout>
