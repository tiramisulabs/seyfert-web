...
<Cards>
    <Card title="Understanding sharding" href="/docs/learn/scaling/sharding">
        Learn what Discord shards are, how `Client` manages them, and when to introduce `WorkerManager`.
    </Card>
    <Card title="Distributed scaling" href="/docs/learn/scaling/distributed">
        Configure the merged `@slipher/scaler` implementation while its first npm release is pending.
    </Card>
    <Card title="Operations and recovery" href="/docs/learn/scaling/operations">
