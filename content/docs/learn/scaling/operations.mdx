...
The `@slipher/scaler` source has landed in `extra` through [pull request #27](https://github.com/tiramisulabs/extra/pull/27), but the package is not published on npm yet. This guide matches the merged implementation.
</Callout>
