...
await guild.members.fetch('406184197405802497');    // Fetch Deivid
...
// ---cut---
const channel = await client.channels.fetch('1003825079328702529');
...
// ---cut---
// Users
await client.users.fetch('366779196975874049');
await client.users.createDM('576805413148688424');

// Messages
await client.messages.write('1003825079328702529', { content: 'Hello' });
await client.messages.edit('1529923192402088189', '1003825079328702529', { content: 'Edited' });
await client.messages.delete('1529923192402088189', '1003825079328702529');

// Members
await client.members.fetch('1003825077969764412', '406184197405802497');
await client.members.edit('1003825077969764412', '410623882152771587', { nick: 'New Name' });
await client.members.kick('1003825077969764412', '220306163957235722');
await client.members.ban('1003825077969764412', '576805413148688424');

// Roles
await client.roles.create('1003825077969764412', { name: 'New Role', color: 0xFF0000 });
await client.roles.edit('1003825077969764412', '1115437277846458388', { name: 'Updated' });

// Guilds
await client.guilds.fetch('1003825077969764412');
...
Transformers.User = (client, data) => {
    return {
        ...
        isAdmin: ['366779196975874049'].includes(data.id),
        raw() {
