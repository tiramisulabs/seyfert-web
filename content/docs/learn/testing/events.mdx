...
This builds on [Setup](/docs/learn/testing/setup). By the end you will register a real event handler, feed it a gateway dispatch event, and assert on what it did — all in-process.
...
- Reference: [The Toolkit › MockGateway](/docs/testing/gateway) for the full emit and gateway surface.
