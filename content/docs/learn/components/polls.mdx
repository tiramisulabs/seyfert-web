...
This is an expanded section of the [configuration file](/docs/learn/getting-started/setup-project#configuration).
...
<Callout type="note">
This is tied to the section on [event creation](/docs/learn/getting-started/listening-events).
</Callout>
...
<Callout type="note">
This goes along with the [Commands](/docs/learn/commands/options) section.
</Callout>
