...
All the builders are sent within an [`ActionRow`](/docs/api/ActionRow:Class). Each message can contain a maxium of 5 actions row.
...
There are diffrent types of select menus: [`StringSelectMenu`](/docs/api/StringSelectMenu:Class), [`UserSelectMenu`](/docs/api/UserSelectMenu:Class), [`RoleSelectMenu`](/docs/api/RoleSelectMenu:Class), [`ChannelSelectMenu`](/docs/api/ChannelSelectMenu:Class) and [`MentionableSelectMenu`](/docs/api/MentionableSelectMenu:Class).
...
const userMenu = new UserSelectMenu()
  ...
  // Seyfert developer user IDs
  .setDefaultUsers('366779196975874049', '576805413148688424');
...
const roleMenu = new RoleSelectMenu()
  ...
  // Seyfert team role IDs
  .setDefaultRoles('1257467909299769436', '1115437277846458388');
...
const channelMenu = new ChannelSelectMenu()
  ...
  // Seyfert community channel IDs
  .setDefaultChannels('1003825079328702529', '1216337232047378462');
...
const mentionableMenu = new MentionableSelectMenu()
  ...
  // Seyfert developer and team role
  .setDefaultMentionables(
    { type: 'User', id: '366779196975874049' },
    { type: 'Role', id: '1115437277846458388' }
  );
