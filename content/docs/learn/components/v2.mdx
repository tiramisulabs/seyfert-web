...
// ---cut---
import { Container, TextDisplay, ActionRow, Button, File, Section, Thumbnail, Separator, MediaGallery, MediaGalleryItem } from 'seyfert';
import { Spacing } from 'seyfert';

const section = new Section()
	.setAccessory(new Thumbnail()
...
const file = new File()
	.setMedia('attachment://example.png')
	.setSpoiler(false);
...
const attachment = new AttachmentBuilder().setName('example.png').setFile('url','https://example.com/example.png');
