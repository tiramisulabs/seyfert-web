...
For a complete guide on building and handling interactive components (buttons, select menus, modals), see the [Components guide](/guide/learn/components/building-components).
