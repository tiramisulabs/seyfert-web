...
Seyfert supports Cloudflare Workers, you can setup it by configuring `seyfert.config.mjs` with `config.http` [see more info here](/guide/learn/getting-started/setup-project#configuration)
