...
This is an expanded section of the [configuration file](/guide/learn/getting-started/setup-project#configuration).
...
<Callout type="note">
This is tied to the section on [event creation](/guide/learn/getting-started/listening-events).
</Callout>
...
<Callout type="note">
This goes along with the [Commands](/guide/learn/commands/options) section.
</Callout>
