...
<Callout type="info">
Full documentation available at [Components v2 Guide](/docs/learn/components/v2).
</Callout>
...
Then dive into the [Components v2 documentation](/docs/learn/components/v2) to start building next-gen UIs.
