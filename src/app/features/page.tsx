...
export default function Page() {
    return <div className=''>
        ...
        <motion.div className='grid grid-cols-1 lg:grid-cols-2 gap-2 my-5' initial={{ y: 10, opacity: 0 }}
            ...
            <SpotlightCard icon={<HeartIcon className='w-10 h-10' />} title="24/6 support (Sunday is for going to church)" description="Seyfert has a good support team who will assist you in your code" />
