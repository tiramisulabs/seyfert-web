...
import HomeSections from "./classic-sections";

// Classic landing — the default home, restored from commit 48dfd0a
// (the state right before the brutalist/chad redesign).
